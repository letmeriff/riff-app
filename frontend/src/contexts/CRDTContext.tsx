...
import { VectorClock, NodePositionOperation } from '../types/crdt';
import { mergeVectorClocks } from '../utils/vectorClock';

/**
 * Context interface for CRDT operations
 */
...
/**
 * Provider component for CRDT functionality
 */
...
/**
 * Hook for using CRDT functionality
 */
